...
gen hot_zone = 1 if (barrio == "Zona T" || barrio == "Zona G" || barrio == "Usaquén" || barrio == "La 93")
replace hot_zone=0 if missing(hot_zone)
...
order encuesta_si hot_zone id nombre barrio p0a_n p3_n p3b_n                ///
